...

{
    ...
    //LoadCertificates(ctx, "mycert.pem", "mydomain.com.key"); /* load certs */
    LoadCertificates(ctx, "testcert.pem", "testkey.pem"); /* load certs */
    syslog(LOG_INFO, "initiating server socket \n");
